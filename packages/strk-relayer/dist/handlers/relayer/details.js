 ...
 */
export function relayerDetailsHandler(req, res, next) {
    // Get query parameters
    const chainIdParam = req.query.chainId;
    const assetAddressParam = req.query.assetAddress;
    // Parse chain ID
    ...
    res.status(200).json(res.locals.marshalResponse(new DetailsMarshall({
