 ...
 */
function relayRequestBodyToWithdrawalPayload(body) {
    return {
        ...body,
        proof: {
            proof: {
 ...
 */
export async function relayRequestHandler(req, res, next) {
    try {
        ...
        const requestResponse = await privacyPoolRelayer.handleRequest(withdrawalPayload, chainId);
        res
            .status(200)
